...
function debounce(func) {
    ...
    return function () {
        // always use this when working with scroll event listener
        var context = this,
            args = arguments;
...
function checkSlide(e) {
    // waypoint npm package in vanilla js
    sliderImages.forEach(function (sliderImage) {
        // halway through the image
        var slideInAt = window.scrollY + window.innerHeight - sliderImage.height / 2 + 150;
        // bottom of the image
